    ...
    <footer className="bg-rose-800 text-white ">
      <div className="container mx-auto py-12 px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4 open-sans-hharryy">Contact Us</h2>
            <p className="text-gray-300 mb-4">
              For more information about VENTUREVAULT and how to participate, please visit our website at{' '}
              <a 
                href="https://venture.cgc.ac.in/tbiventurenest" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-blue-300 hover:underline"
              >
                venture.cgc.ac.in/tbiventurenest
              </a> 
              {' '}or contact us at{' '}
              <a 
                href="mailto:venturenest@cgc.ac.in" 
                className="text-blue-300 hover:underline"
              >
                venturenest@cgc.ac.in
              </a>.
            </p>
            <p className="text-lg text-gray-300 italic">
                Join Venture Vault today and be part of a transformative journey towards innovation and success!
            </p>
          </div>

          {/* Follow Us Section */}
          <div className="md:text-right">
            <h2 className="text-2xl font-bold mb-4 open-sans-hharryy">Follow Us</h2>
        ...
        <div className="border-t border-white mt-8 pt-6 text-center text-white">
          <p>&copy; {new Date().getFullYear()} Venture Vault. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
